...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative flex flex-col items-center justify-center text-center min-h-[90vh] px-6 py-20 bg-gradient-to-b from-black via-gray-900 to-indigo-950 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-3xl">
        ...
        <p className="text-gray-300 text-lg md:text-xl mb-10 leading-relaxed">
          SphereX Community connects innovators, enthusiasts, and changemakers through collaboration, learning, and growth.
